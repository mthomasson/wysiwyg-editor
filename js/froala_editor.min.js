        ...
        function start(e) {
            ...
            return function() {
                ...
                if (o) {
                    ...
                    o = $('<p contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1">' + e.clipboardData.getData("text/rtf")'</p>');
                    if (editor.browser.safari) {
                        o.css("top", editor.$sc.scrollTop());
                        editor.$el.after(o);
                    } else {
                        if ((editor.browser.edge || editor.browser.chrome) && editor.opts.iframe) {
                            debugger
                            editor.$el.append(o);
                        } else {
                            editor.$box.after(o);
